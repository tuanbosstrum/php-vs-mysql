...
<?php
	$sql = "select * from sanpham where MANHOM='nruou'";
...
?>
    ...
    <div class="column">
        <div class="card">
            <img id="myImg" src="<?php echo $data['HINHANH']; ?>" alt="" style="width:90%; height:300px; text-align: center;">
            <div class="container">
                <div class="row">
                    <h2 id="name"><?php echo $data['TENSP']; ?></h2>
                    <div class="column2">
                        <p id="money"><?php echo $data['GIA']; ?></p>   
                    </div>
                    <div class="column3">
                    ...
                    <div class="overlay-content">
                        <div class="row">
                            <div class="column2" id="left2">
                              <div class="card2">
                                <img src="<?php echo $data['HINHANH']; ?>" alt="" height="400px">
                              </div>
                            </div>
                            ...
                            <div class="column2">
                              <div class="card2">
                                <div class="container">
                                  ...
                                  <h2><?php echo $data['GIA']; ?></h2>
                                  <p style="text-align:left;font-weight:700;"><?php echo $data['MOTA']; ?></p>
                                </div>
                                <div class="container2">
                                    <input class="number" type="number" id="quantity" name="quantity" value="1" min="1" max="<?php echo $data['SOLUONG']?>">
